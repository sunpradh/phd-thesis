...
\begin{itemize}
    ...
    \item nuclear magnetic resonance systems \cite{somaroo1999simulation, tseng1999nmr};
...
Thanks to the development of quantum information, new \emph{classical algorithms} have been invented for the simulation of quantum many-body systems, that much more exploit the quantum nature of these systems.
...
The order of the indices $\alpha_n$ depends on the number of Schmidt eigenvalues of the bipartition that separates the first $n$ sites from the rest.
