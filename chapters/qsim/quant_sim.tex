...
Analog \ac{qs} is another type of approach to \ac{qs}, where one quantum system (the simulator) mimics or emulate another (the target) \cite{buluta2009simulators, wei1997simulation, arguello2019simulation, aspuruguzik2012photonic, blatt2012trappedions, bloch2012ultracold, houck2012superconducting}.
...
Some historical examples can be the astrolabe for plotting the heavens, or the mechanical differential analyser for integrating differential equations \cite{thomson1876integration}.


The Hamiltonian of the system to be simulated, $H^{\text{sys}}$, is directly mapped onto the Hamiltonian of the quantum simulator, $H^{\text{sim}}$:
\begin{equation*}
    H^{\text{sys}} \longleftrightarrow H^{\text{sim}}.
\end{equation*}
