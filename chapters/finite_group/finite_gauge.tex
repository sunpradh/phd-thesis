...
% In the Hamiltonian formulation of \ac{lgt}s \cite{kogut2975hamiltonian, milstead2018qyangmills, ZoharBurrello}, time is continuous while the $d$ spatial dimensions are discretized into a hypercubic lattice.
...
The only physical states are those which satisfy the so-called \say{Gauss' law} constraint \cite{kogut2975hamiltonian, milstead2018qyangmills, tong2018gauge}
\begin{equation}
...
%
\subsection{The representation basis and the Peter-Weyl theorem}
\label{sec:representation basis}
...
In the Lie group case, the electric and magnetic Hamiltonians form the so-called Kogut-Susskind Hamiltonian where \cite{kogut2975hamiltonian, milstead2018qyangmills}
\begin{equation}
