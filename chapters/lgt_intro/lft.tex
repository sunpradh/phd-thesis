...
In an \ac{lft}, both the vertices and edges (also called links) host degrees of freedom (d.o.f).
...
% One of the most important quantity that can be computed for a pure \ac{lgt} is the Wilson loop for generic closed paths $\mathcal{C}$.
