...
Even tough Wilson formulation \cite{wilson1974confinement} was in the path-integral and Lagrangian language, we will also review the Hamiltonian formulation of non-Abelian \ac{qft} because its connection to \acl{qs}.
...
Moreover, even \emph{\ac{lgt}s}, at least in the path-integral formulation, is not applicable for $\mu \neq 0$ due to the infamous \emph{sign problem}.
