...
\begin{theorem}[Orthogonality theorem for compact Lie groups]
...
The Peter-Weyl theorem is instrumental in the formulation of the Hamiltonian in \todo{inserire sec ref}.
See \todo{cit. T. Tao e A. W. Knapp}\citneeded for the Lie group case and \todo{cit. J. P. Serre}\citneeded for the finite group case.
...
Consider the examples of $\SU(2) $ \todo{citare Milstead Osborne}\citneeded, but the generalisation is easy.
...
Crucially, the Peter-Weyl theorem also holds for finite groups (\todo{citare J.P. Serre}\citneeded):
