...
In this section we discuss the main result in \cite{pradhan2022ladder}, which is a construction of a duality map between a \acfp{lgt} on a \emph{ladder geometry} and \emph{\aclp{clock}}.
...
Gauss law have to be satisfied in a pure gauge theory, which mean that we have to impose $G^\uparrow_i = \identity$ and $G^\downarrow_i = \identity$ for all $x$.
