...
The Toric code is two-dimensional model of spin-\onehalf degrees of freedom (d.o.f), which can be regarded as an example of a pure $\mathbb{Z}_2$ \ac{lgt}.
...
\begin{figure}[t]
    \SideFigure[label={fig:toric_code_operators}, desc={Vertex and plaquette operators of the Toric Code}]{ %
...
\begin{figure}[t]
    \SideFigure[label=fig:nonlocal_operators_TC, desc={Non-local operators in the Toric Code}]{%
...
%
\subsection{Toric Code as a \texorpdfstring{$\Z_2$}{Z2} \ac{lgt}}
\label{sub:toric_code_as_a_z2_lattice_gauge_theory}

The Toric Code was formulated as a type of error-correcting code for quantum computing, but it can be reinterpreted as a pure $\Z_2$ \ac{lgt}.
