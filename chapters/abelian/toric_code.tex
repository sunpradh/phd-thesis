...
\begin{figure}[t]
    \FigureSideCaption[fig:nonlocal_operators_TC]{%
        ...
        On the non-contractible loops $\mathcal{L}_1$ and $\mathcal{L}_2$ (in the direct lattice) we have defined $\overline{W}_1$ and $\overline{W}_2$ (see \eqref{eq:nonlocal_X_operators} ).
...
\begin{figure}[t]
    \FigureSideCaption[fig:gauge_inv_vertices_z2]{%
        ...
        Gauge invariant vertex states for the $\Z_2$ lattice gauge theory.
...
\begin{figure}[t]
    \FigureSideCaption[fig:physical_state_z2]{%
        ...
        Example of a physical state in the $\Z_2$ lattice gauge theory
    }
\end{figure}
