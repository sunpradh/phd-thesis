...
\begin{figure}[t]
    \FigureSideCaption[fig:star_plaq_operators]{
...
% These models are akin to the Toric Code \cite{kitaev2003fault}, which can be thought as a prime example of a $\Z_2$ \ac{lgt}.
...
% Therefore, in general the $\Z_N$ models described in \eqref{eq:hamiltonian_base} can be considered as generalization of the Toric Code, from the point of view of \ac{lgt}s.
