...
\tikzset{
    ...
    vertex space/.style = {dotted, draw opacity=0.6, Green, fill=Green, fill opacity=0.2},
    link/.style={thick, black, ->-=0.55},
    % D4 generating sets
    set NR/.style = {very thick, Red},
    set R/.style = {very thick, Blue80, densely dotted},
    set D/.style = {very thick, Green, densely dashed}
}
...
\usepackage{pgfplots}
\pgfplotsset{
    compat=1.16, % fixes some pgfplots cross-platform issue
    table/col sep=comma
}
