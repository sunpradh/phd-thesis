...
%----------------------------------------
\usepackage{tikz}
\usetikzlibrary{arrows.meta, decorations.markings, patterns, fit, positioning, backgrounds}
...
\tikzset{
    ...
    % Quantum gates
    gate/.style = {draw=black, fill=white, thick, minimum size=0.6cm, inner sep=1pt, font=\footnotesize},
