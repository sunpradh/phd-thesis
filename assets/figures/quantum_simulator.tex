\begin{tikzpicture}[
    ...
    ->/.style={-stealth, ultra thick, shorten >=3pt, shorten <=3pt, Grey80},
    system/.style = {draw, dotted, thick, rounded corners, inner sep=10pt, fill=Green, fill opacity=0.1},
    simulator/.style = {draw, thick, rounded corners, inner sep=10pt, fill=Blue, fill opacity=0.1}
    ]
