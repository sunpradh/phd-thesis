...
% \bibliography{assets/biblio_tmp.bib}

% Make the title an hyperlink with the url of the reference
\newbibmacro{string+doi}[1]{%
  \iffieldundef{doi}{#1}{\href{http://dx.doi.org/\thefield{doi}}{#1}}}
\DeclareFieldFormat{title}{\usebibmacro{string+doi}{\mkbibemph{#1}}}
\DeclareFieldFormat[article]{title}{\usebibmacro{string+doi}{\mkbibquote{#1}}}

% First initial and then last name
\DeclareNameAlias{default}{given-family}

% Use a simply comma before last author name
...
\DeclareAcronym{cm}{short={CM}, long={Condensed Matter}}
\DeclareAcronym{ym}{short={YM}, long={Yang-Mills}}
\DeclareAcronym{qft}{short={QFT}, long={Quantum Field Theory}, long-plural-form={Quantum Field Theories}}
\DeclareAcronym{qcd}{short={QCD}, long={Quantum Chromodynamics}}
\DeclareAcronym{qed}{short={QED}, long={Quantum Electrodynamics}}
\DeclareAcronym{lft}{short={LFT}, long={Lattice Field Theory}, long-plural-form={Lattice Field Theories}}
\DeclareAcronym{lgt}{short={LGT}, long={Lattice Gauge Theory}, long-plural-form={Lattice Gauge Theories}}
...
\DeclareAcronym{dmrg}{short={DMRG}, long={Density Matrix Renormalization Group}}
\DeclareAcronym{tn}{short={TN}, long={Tensor Network}}
\DeclareAcronym{mps}{short={MPS}, long={Matrix Product State}}
\DeclareAcronym{peps}{short={PEPS}, long={Projected Entangled Pair State}}
\DeclareAcronym{mera}{short={MERA}, long={Multiscale Entanglement Renormalization Ansatz}}
\DeclareAcronym{svd}{short={SVD}, long={Singular Value Decomposition}}
\DeclareAcronym{mc}{short={MC}, long={Monte Carlo}}
\DeclareAcronym{irrep}{short={irrep}, long={irreducible representations}}
